...
public class InnerJoinActivity {
    ...
    public Set<Pair<Integer, String>> problem1() {
         ...
         * Lovelace's students. Notice that
         * Ms. Lovelace teaches two classes, but which classes she teaches aren't known
         * from the data in the student
         * table. This means that you will need a way to combine the data from the two
         * tables (inner join).
         *
         * NOTE: You will need to simultaneously filter those results from the JOIN with
         * a WHERE clause for the
         ...
         * specify the column in your
         * statement by writing table.column, because the column names may be ambiguous
